...
object WhatsAppHelper {
    ...
    suspend fun findAndClickSearch(rootNode: AccessibilityNodeInfo, packageName: String): Boolean {
        for (attempt in 1..5) {
            try {
                ...
                Logger.error("Error in findAndClickSearch attempt $attempt", e)
                delay(1500)
            }
        }
        return false
    ...
    suspend fun enterSearchText(rootNode: AccessibilityNodeInfo, packageName: String, text: String): Boolean {
        for (attempt in 1..5) {
            try {
                ...
                Logger.error("Error in enterSearchText attempt $attempt", e)
                delay(1500)
            }
        }
        return false
            ...
            try {
                ...
                val contactRows = CONTACT_RESULT_IDS.flatMap { id ->
                    try {
                        ...
                        Logger.error("Error finding contact rows with id $id", e)
                        emptyList()
                    }
                }
                ...
                if (contactRows.isNotEmpty()) {
                    ...
                    for (row in contactRows) {
                        try {
                            ...
                            Logger.error("Error processing contact row in attempt $attempt", e)
                        }
                    }
                    ...
                    if (firstRow?.isClickable == true) {
                        try {
                            ...
                            Logger.error("Error clicking first contact row", e)
                        }
                    }
                }
                ...
                if (contactNames.isNotEmpty()) {
                    try {
                        ...
                        Logger.error("Error clicking contact name element", e)
                    }
                }
                
                delay(2000) // Longer delay for contact results to appear
            } catch (e: Exception) {
                Logger.error("Error in clickContactResult attempt $attempt", e)
                delay(2000)
            }
        }
        return false
    ...
    suspend fun enterMessage(rootNode: AccessibilityNodeInfo, packageName: String, message: String): Boolean {
        for (attempt in 1..5) {
            try {
                ...
                Logger.error("Error in enterMessage attempt $attempt", e)
                delay(1500)
            }
        }
        return false
    ...
    suspend fun clickSendButton(rootNode: AccessibilityNodeInfo, packageName: String): Boolean {
        for (attempt in 1..5) {
            try {
                ...
                Logger.error("Error in clickSendButton attempt $attempt", e)
                delay(1500)
            }
        }
        return false
    ...
    private fun isPhoneNumberMatch(contactName: String, searchText: String): Boolean {
        return try {
            ...
            Logger.error("Error in phone number matching", e)
            false
        }
    }
}